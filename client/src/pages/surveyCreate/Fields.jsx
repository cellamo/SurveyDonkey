...
export const fields = [
    {type: "multiplechoice", icon: "pi pi-check", name: "Multiple Choice", explanation: "Choose from a list of predefined options."},
    {
        type: "singlechoice",
    ...
    {type: "checkbox", icon: "pi pi-check-square", name: "Checkboxes", explanation: "Can Select multiple options from a list."},
    {   type: "dropdown",
        icon: "pi pi-arrow-circle-down",
        name: "Dropdown List",
        explanation: "A single-choice question in the form of a dropdown menu."
    },
    {type: "star", icon: "pi pi-star", name: "Star Rating", explanation: "Lets rate items with stars to express their satisfaction."}
];
    ...
    dropdown: () => (
        ...
        <div>
            <Dropdown options={["Option 1", "Option 2", "Option 3"]}
                      placeholder="Select an answer" className="w-full md:w-14rem" />
        </div>
    </div>),
